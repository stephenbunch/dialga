...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function _extendableBuiltin(t){function e(){var e=Reflect.construct(t,Array.from(arguments));return Object.setPrototypeOf(e,Object.getPrototypeOf(this)),e}return e.prototype=Object.create(t.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t,e}Object.defineProperty(exports,"__esModule",{value:!0});var NotSupportedError=function(t){function e(t){_classCallCheck(this,e);var r=_possibleConstructorReturn(this,Object.getPrototypeOf(e).call(this));return r.name="NotSupportedError",r.message=t,r}return _inherits(e,t),e}(_extendableBuiltin(Error));exports["default"]=NotSupportedError;

},{}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}Object.defineProperty(exports,"__esModule",{value:!0});var _Pattern=require("./Pattern"),_Pattern2=_interopRequireDefault(_Pattern),_Mask=require("./Mask"),_Mask2=_interopRequireDefault(_Mask),_days=require("./days"),_days2=_interopRequireDefault(_days),_type=require("./type"),_type2=_interopRequireDefault(_type),_InvalidDateError=require("./errors/InvalidDateError"),_InvalidDateError2=_interopRequireDefault(_InvalidDateError),_InvalidMaskError=require("./errors/InvalidMaskError"),_InvalidMaskError2=_interopRequireDefault(_InvalidMaskError),_InvalidOperationError=require("./errors/InvalidOperationError"),_InvalidOperationError2=_interopRequireDefault(_InvalidOperationError),_InvalidPatternError=require("./errors/InvalidPatternError"),_InvalidPatternError2=_interopRequireDefault(_InvalidPatternError),_NotSupportedError=require("./errors/NotSupportedError"),_NotSupportedError2=_interopRequireDefault(_NotSupportedError),_exports=function(){return new _Pattern2["default"]};_exports.Pattern=_Pattern2["default"],_exports.Mask=_Mask2["default"],_exports.days=_days2["default"],_exports.type=_type2["default"],_exports.errors={InvalidDateError:_InvalidDateError2["default"],InvalidMaskError:_InvalidMaskError2["default"],InvalidOperationError:_InvalidOperationError2["default"],InvalidPatternError:_InvalidPatternError2["default"],NotSupportedError:_NotSupportedError2["default"]},exports["default"]=_exports;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function getDate(e){if(!DATE_PATTERN.test(e))throw new _InvalidDateError2["default"]('Date "'+e+'" is invalid. Expected format to be YYYY-MM-DD.');var t=new Date(e+"T00:00:00.000Z");if(isNaN(t.getTime()))throw new _InvalidDateError2["default"]('Date "'+e+'" is invalid.');return t}function validateDate(e){getDate(e)}function getString(e){var t=(e.getUTCMonth()+1).toString();1===t.length&&(t="0"+t);var r=e.getUTCDate().toString();return 1===r.length&&(r="0"+r),e.getUTCFullYear()+"-"+t+"-"+r}function getDayOfWeek(e){return e.getUTCDay()}function getDayOfWeekFlag(e){return dayOfWeekToFlag(getDayOfWeek(e))}function dayOfWeekToFlag(e){return Math.pow(2,e)}function getSunday(e){return plusDays(e,-getDayOfWeek(e))}function hasFlag(e,t){return(e&t)===t}function durationToDays(e){return+e/1e3/60/60/24}function durationToWeeks(e){return durationToDays(e)/7}function daysToDuration(e){return 24*e*60*60*1e3}function plusDays(e,t){return new Date(+e+daysToDuration(t))}function plusWeeks(e,t){return plusDays(e,7*t)}function dayOfWeekMaskToArray(e){var t=[0,1,2,3,4,5,6],r=[];return t.forEach(function(t){hasFlag(e,dayOfWeekToFlag(t))&&r.push(t)}),r}function normalizeDirection(e){return 0>e?-1:1}function extend(e,t){var r;t=t||{};for(r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r]);return e}function find(e,t){var r=findIndex(e,t);return r>-1?e[r]:null}function findIndex(e,t){for(var r=0;r<e.length;r++)if(t(e[r]))return r;return-1}function repeat(e,t){for(var r="",a=0;t>a;a++)r+=e;return r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.getDate=getDate,exports.validateDate=validateDate,exports.getString=getString,exports.getDayOfWeek=getDayOfWeek,exports.getDayOfWeekFlag=getDayOfWeekFlag,exports.dayOfWeekToFlag=dayOfWeekToFlag,exports.getSunday=getSunday,exports.hasFlag=hasFlag,exports.durationToDays=durationToDays,exports.durationToWeeks=durationToWeeks,exports.daysToDuration=daysToDuration,exports.plusDays=plusDays,exports.plusWeeks=plusWeeks,exports.dayOfWeekMaskToArray=dayOfWeekMaskToArray,exports.normalizeDirection=normalizeDirection,exports.extend=extend,exports.find=find,exports.findIndex=findIndex,exports.repeat=repeat;var _InvalidDateError=require("./errors/InvalidDateError"),_InvalidDateError2=_interopRequireDefault(_InvalidDateError),DATE_PATTERN=/[0-9]{4}\-[0-9]{2}\-[0-9]{2}/;

},{"./errors/InvalidDateError":4}]},{},[9])(9)
});
//# sourceMappingURL=dialga.min.js.map?fb164d9698121e80ca8c54501f603e64202b8209
